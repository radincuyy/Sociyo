...
export function StoryViewerScreen({ navigation }: StoryViewerProps) {
  ...
  return (
    <Screen padded={false}>
      ...
      <View style={styles.content}>
        ...
        >
          <Text style={[styles.emptyTitle, { color: palette.text }]}>Story belum tersedia</Text>
          <Text style={[styles.emptyCopy, { color: palette.textMuted }]}>
            Story akan tampil setelah data story disambungkan ke Firebase.
          </Text>
        </View>
      </View>
    </Screen>
